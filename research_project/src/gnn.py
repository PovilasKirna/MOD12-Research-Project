...
#             full_feature = list(binary_flags) + [utility] + [norm_x, norm_y]
...
#     ):
#         super().__init__()
#         self.conv1 = GCNConv(in_channels=input_dim, out_channels=hidden_channels)
...
#             "output_dim": output_dim,
#         },
#         "research_project\models/checkpoint6_GCN.pt",
#     )
...
def train():
    ...
    torch.save(
        ...
        "research_project\models/checkpoint7.pt",
    )
